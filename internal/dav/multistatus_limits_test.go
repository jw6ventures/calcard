...
func TestCalendarReportStopsBuildingAtOverflowSentinel(t *testing.T) {
	...
	responses, err := h.calendarResourceReportResponses(context.Background(), &store.User{ID: 1}, "/dav/calendars/1/", events, propertySelector{Prop: &reportProp{}}, calendarDataProjection{})
	if err != nil {
